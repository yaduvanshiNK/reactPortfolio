...
const FeaturedProjectsData = [
  ...
  {
    websitePreview: images.Grover,
    projectName: "Grover",
    projectDesc:
      "Created a simple and intuitive website with a clean and modern design. The website's home page featured a prominent call-to-action to download the app and a clear explanation of the app's features and benefits. The site was optimized for mobile devices to ensure a seamless user experience for customers on the go.",
    usedTech: ["HTML", "sass", "javaScript", "GSAP"],
